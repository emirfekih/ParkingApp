...
public class ReponseParking
{
    ...
    public ReponseParking(long idParking,String nom, String horaire, String distanceToOrigine, String durationToOrigine,double moyenne,String placeDisponibles) {
        this.nom= nom;
        this.horaire=horaire;
